                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children active dropdown-menu">
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Bestandsstatistik</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">News</a></li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <!-- <div class="card">
                        ...
                        <div class="card-body">-->
                            <?php
	                            include("assets/logic/mLagerbestand.php");
	                        ?>
