...
try {
    ...
    $sql = "SELECT COUNT(*) FROM tUser WHERE username = :username AND password = :password AND isAdmin = 1 AND active = 1 AND isSuperadmin = 1";
    ...
    else
    {
        ...
        header("Location: ../../amazonMarketplaceLogin.php?tries=" . $tries[0]['tries']);
    }
