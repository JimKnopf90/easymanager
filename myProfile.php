    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="images"><img src="images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="images"><img src="images/logo2.png" alt="Logo"></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Lagerbestand</a></li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Mein Profil</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="Vorname" class="form-control"><small class="form-text text-muted">Bitte hinterlege deinen Vorname</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nachname</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="Nachname" class="form-control"><small class="form-text text-muted">Bitte hinterlege deinen Nachname</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Geburtstag</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="Geburtsdatum" class="form-control"><small class="form-text text-muted">Bitte hinterlege dein Geburtsdatum z.B. 02.05.1990</small></div>
                            </div>
                            <div class="row form-group">
